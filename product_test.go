...
func TestProductList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products.json", client.ApiClient.GetPathPrefix()),
...
func TestProductListFilterByIds(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://fooshop.myshopify.com/%s/products.json", client.ApiClient.GetPathPrefix()),
		params,
...
func TestProductListAll(t *testing.T) {
	...
	listURL := fmt.Sprintf("https://fooshop.myshopify.com/%s/products.json", client.ApiClient.GetPathPrefix())
...
func TestProductCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/count.json", client.ApiClient.GetPathPrefix()),
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://fooshop.myshopify.com/%s/products/count.json", client.ApiClient.GetPathPrefix()),
		params,
...
func TestProductGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1.json", client.ApiClient.GetPathPrefix()),
...
func TestProductCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://fooshop.myshopify.com/%s/products.json", client.ApiClient.GetPathPrefix()),
...
func TestProductUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1.json", client.ApiClient.GetPathPrefix()),
		httpmock.NewBytesResponder(200, loadFixture("product.json")))
...
func TestProductDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1.json", client.ApiClient.GetPathPrefix()),
...
func TestProductListMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields.json", client.ApiClient.GetPathPrefix()),
...
func TestProductCountMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields/count.json", client.ApiClient.GetPathPrefix()),
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields/count.json", client.ApiClient.GetPathPrefix()),
		params,
		httpmock.NewStringResponder(200, `{"count": 2}`))
...
func TestProductGetMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields/2.json", client.ApiClient.GetPathPrefix()),
...
func TestProductCreateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields.json", client.ApiClient.GetPathPrefix()),
...
func TestProductUpdateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields/2.json", client.ApiClient.GetPathPrefix()),
		httpmock.NewBytesResponder(200, loadFixture("metafield.json")))
...
func TestProductDeleteMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://fooshop.myshopify.com/%s/products/1/metafields/2.json", client.ApiClient.GetPathPrefix()),
		httpmock.NewStringResponder(200, "{}"))
