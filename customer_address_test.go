...
func TestList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/customers/1/addresses.json", client.ApiClient.GetPathPrefix()), httpmock.NewBytesResponder(200, loadFixture("customer_addresses.json")))
...
func TestGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", fmt.Sprintf("https://fooshop.myshopify.com/%s/customers/1/addresses/1.json", client.ApiClient.GetPathPrefix()), httpmock.NewBytesResponder(200, loadFixture("customer_address.json")))
...
func TestCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", fmt.Sprintf("https://fooshop.myshopify.com/%s/customers/1/addresses.json", client.ApiClient.GetPathPrefix()), httpmock.NewBytesResponder(200, loadFixture("customer_address.json")))
...
func TestUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", fmt.Sprintf("https://fooshop.myshopify.com/%s/customers/1/addresses/1.json", client.ApiClient.GetPathPrefix()), httpmock.NewBytesResponder(200, loadFixture("customer_address.json")))
...
func TestDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", fmt.Sprintf("https://fooshop.myshopify.com/%s/customers/1/addresses/1.json", client.ApiClient.GetPathPrefix()), httpmock.NewStringResponder(200, "{}"))
